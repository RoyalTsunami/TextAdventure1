...
def playGame():
    ...
    while choice is None:
        ...
        if movement == "open":
            ...
            print("Invalid choice, please type 'open' or 'look'. Try again.")
    ...
    if rope:
        ...
        while choice is None:
            ...
            if movement == "yes":
                ...
                decision = None
                while decision is None:
                    movement = input("Would you like to use the rope "
                                     "or to just jump down? (rope/jump) ").lower().strip()
                    if movement == "rope":
                        decision = "rope"
                        ...
                        print("You embraced your inner action hero and threw the rope aside.\n"
                              "You leaped out of the window, expecting a heroic landing, "
                              "but instead broke both your legs.\n"
